...
<head>
	...
	<!--可无视-->
	<link rel="stylesheet" type="text/css" href="assets/main/css/normalize.css" />
	<link rel="stylesheet" type="text/css" href="assets/main/css/reset.css">
...
<body>
	...
	<div class="changer">
	  <h1><a href="/auth/login" style="text-decoration: none;" hover="color:orange;">立即进入</a></h1>
	</div>
	<div id="container"></div>
	
	<script src="assets/main/js/jquery-1.11.0.min.js" type="text/javascript"></script>
	<script>
		var demos = [];
		var cloudsuit = {
			one: {
				bg: "assets/main/images/ZnkfwAR.jpg",
				bm: "none" },

			two: {
				bg: "assets/main/images/ONBXKkS.jpg",
				bm: "lighten" },

			three: {
				bg: "assets/main/images/qKNpn9G.png",
				bm: "multiply" } };
